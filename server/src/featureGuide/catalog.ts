...
export const BOT_FEATURES: BotFeature[] = [
  ...
  },
  {
    ...
    announcement: 'Chats now combines People and Bots with separate unread indicators. Type @ in a private conversation to start a group with an accessible bot and review the context you share.',
  ...
  },
  {
    ...
    agent: 'Explain Organize bots for personal display-group creation, renaming, and deletion. Bots can be dragged to groups or moved with Actions → Move to… → No group. These groups never change business roles, access, or huddle membership. Desktop Chats shows latest indexed assistant replies. Explain the sidebar Actions menu for personal pins and unread status. Use a real wakeup or routine when the user requests future work; unread status is not a scheduler.',
  },
  {
